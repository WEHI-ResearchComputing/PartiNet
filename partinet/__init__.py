...
def train_common_args(f):
    ...
    f = click.option('--backbone-detector', type=click.Choice(["yolov7", "yolov7x", "yolov7-w6", "yolov7-e6", "yolov7-d6", "yolov7-e6e"], case_sensitive=False), help='The choice of backbone to be used.', default="yolov7", show_default=True)(f)
