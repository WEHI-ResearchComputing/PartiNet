...
@click.option('--save-txt', is_flag=True, default=True, help='save results to *.txt, (default: enabled) ')
@click.option('--save-conf', is_flag=True, default=True, help='save confidences in --save-txt labels (default: enabled)')
